      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-4 font-display text-2xl tracking-tight text-blue-900">
            One Ummah’s projects have changed millions of lives and brought
            relief, ease and contentment to many around the world. Our projects
            include food distributions, building water wells, providing medicine
            and shelter, educating and sponsoring children and orphans and many
            many more.
          </p>
        </div>
        <Tab.Group
